...
export default function SummerPrograms({ events }) {
  return (
    <>
      <section className={style.header}>
        <img
          src="/assets/images/Academic/download5.jpg"
          alt="About Image"
          loading="eager"
      ...
      <section className={style.redContainer}>
        <h1>Summer Programs Highlights</h1>
        <ul>
      ...
      <section className={style.whiteContainer}>
        <h1>Upcoming Summer Programs Events</h1>
        {events.length > 0 && (
          <ul
            style={{
              marginTop: "50px",
