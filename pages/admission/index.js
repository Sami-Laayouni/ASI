  ...
  return (
    <>
      ...
      <section className={style.container}>
        ...
        <p>
          Aenean auctor at enim non imperdiet. Suspendisse laoreet hendrerit
          nisi ut pretium. Suspendisse cursus tortor a luctus imperdiet. Nunc
          ultrices odio in lacus sodales, et egestas lectus ultricies. In vitae
          libero justo. Nam gravida elementum mauris in hendrerit. Morbi vitae
          ante rhoncus, interdum purus sed, tempus diam. Aliquam sodales commodo
          euismod. Phasellus nec rhoncus nunc, dapibus consectetur ipsum. Mauris
          ornare fringilla nunc, eu commodo eros molestie sit amet. Pellentesque
          lobortis maximus odio auctor tempor. Nam quis nisi finibus, consequat
          velit consequat, finibus mi. Vivamus nec erat in sem faucibus lacinia.
          Integer tincidunt consectetur massa, vitae iaculis velit commodo
          pretium. Mauris mattis erat vitae tincidunt efficitur.
        </p>
        <h1 className={style.underline_text}>
          Lorem ipsum dolor sit amet, consectetur adipiscing elit.
        </h1>
